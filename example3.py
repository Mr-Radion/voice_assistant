...
def makeSomething(zadanie):
    ...
    # Аналогично
        ...
        talk("Меня зовут Альтрон")
    elif 'переведи на русский' in zadanie:
        translator.english_to_russian()
    else:
        talk("Команда не распознана, повторите!")
